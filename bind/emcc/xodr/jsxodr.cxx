...
//
	...
	.property("g_additionalData", &t_road_railroad_switch_mainTrack::m_g_additionalData ) // group read 
; 
//
	...
	.property("g_additionalData", &t_road_railroad_switch_partner::m_g_additionalData ) // group read 
; 
//
	...
	.property("g_additionalData", &t_road_railroad_switch_sideTrack::m_g_additionalData ) // group read 
; 
//
...
//
	...
	.property("g_additionalData", &t_road_signals_signal::m_g_additionalData ) // group read 
		.property("t_road_signals_signal", &t_road_signals_signal::m_t_road_signals_signal ) //
; 
...
//
	class_<t_road_planView_geometry>("t_road_planView_geometry") 
		...
		.property("t_road_planView_geometry", &t_road_planView_geometry::m_t_road_planView_geometry ) //
; 
//
...
//
	class_<t_road_objects_object_markings_marking>("t_road_objects_object_markings_marking") 
		...
		.property("side", &t_road_objects_object_markings_marking::side) //required
...
//
	...
	.property("g_additionalData", &t_road_objects_object_outlines_outline::m_g_additionalData ) // group read 
		.property("t_road_objects_object_outlines_outline", &t_road_objects_object_outlines_outline::m_t_road_objects_object_outlines_outline ) //
; 
//
...
//
	...
	.property("g_additionalData", &t_road_lanes_laneSection_lr_lane::m_g_additionalData ) // group read 
		.property("t_road_lanes_laneSection_lr_lane", &t_road_lanes_laneSection_lr_lane::m_t_road_lanes_laneSection_lr_lanes ) //
; 
