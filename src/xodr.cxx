...
//
//  Created by Javed Shaik on Mon Jul  6 00:34:53 2020
//  # AUTO-GENERATED FILE - DO NOT EDIT!!
//  -- UUIDv4 : 834104c8-e9cc-4b14-8df7-a88a4310623c --
...
t_road_objects_object::t_road_objects_object(pugi::xml_node node)
{
	...
	{
		m_repeats.push_back(std::make_unique<t_road_objects_object_repeat>(e_repeat));
	}
...
t_road_objects_object_outlines_outline::t_road_objects_object_outlines_outline(pugi::xml_node node)
{
   ...
   //group tag : reference g_additionalData
	...
	if (node.first_child()) { m_t_road_objects_object_outlines_outline = std::make_unique<t_road_objects_object_outlines_outline_U>(node.first_child()); }
}
...
void xodr::load(std::string xodrfilename )
{
	...
	{
		std::cout << " Failed to load xml definition file .. %s \n" << xodrfilename.c_str();
		return;
	}
	m_root = m_doc.root();
}
